...
This project is indexed by GitNexus as **4-life** (4411 symbols, 10905 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
