...
This project is indexed by GitNexus as **4-life** (4400 symbols, 10909 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
