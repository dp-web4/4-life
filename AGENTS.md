...
This project is indexed by GitNexus as **4-life** (5341 symbols, 13103 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
