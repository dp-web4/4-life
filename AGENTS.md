...
This project is indexed by GitNexus as **4-life** (5353 symbols, 13113 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
