    ...
    <div className="space-y-8">
      ...
      <section className="text-center" style={{ maxWidth: '48rem', margin: '0 auto' }}>
        ...
        <p style={{
          ...
          <strong>Web4</strong> is a proposed protocol where trust is built into the internet itself, not bolted on after the fact — that&apos;s what &quot;trust-native&quot; means.
        ...
        <ul style={{
          ...
          <li className="card" style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
            ...
            <div>
              ...
              <p style={{ color: 'var(--color-text-secondary)', margin: '0.25rem 0 0', fontSize: '0.9rem' }}>
                Every action costs energy from a personal budget called <TermTooltip term="ATP">ATP (Attention Transfer Packets)</TermTooltip>. Quality earns it back. Spam burns through it with no return.
              </p>
            </div>
          </li>
          <li className="card" style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
