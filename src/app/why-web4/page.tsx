      ...
      <section className="max-w-2xl mx-auto mt-12 text-center">
        <div className="bg-gradient-to-r from-sky-950/40 to-purple-950/40 border border-sky-800/30 rounded-xl p-6">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <a href="/day-in-web4" className="inline-block px-5 py-2.5 bg-emerald-600/20 border border-emerald-500/40 rounded-lg text-emerald-300 font-semibold text-sm hover:bg-emerald-600/30 transition-colors no-underline">
              See what the apps look like →
            </a>
