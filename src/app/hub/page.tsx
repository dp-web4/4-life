    ...
    <>
      ...
      <section className="max-w-4xl mx-auto">
        ...
        <p className="text-xl text-gray-300 leading-relaxed mb-4">
          A <Link href="/society-simulator" className="text-purple-300 underline hover:text-purple-200">society</Link>{" "}
          in this site&apos;s simulations is a swarm of agents forming trust. The{" "}
          <strong>hub</strong> is a runnable version of exactly that: a single
          ~6&nbsp;MB Rust daemon that turns a real community into a sovereign Web4
          society — with its own roles, its own law, and its own tamper-evident
          history.
        </p>
        <p className="text-lg text-gray-400 leading-relaxed">
          ...
          is the trust layer for a <em>single</em> entity, the hub is the trust
          layer for a <em>group</em>. It&apos;s a reference proof-of-concept any
      ...
      <section className="max-w-4xl mx-auto mt-12">
        <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-4">
          ...
          <p className="text-sm text-gray-300 leading-relaxed">
            The hub is <MaturityBadge tier="reference" /> — MVP-complete and runnable,
            a proof-of-concept that demonstrates the model end to end. A
            hardware-bound, multi-signature unlock for a hub is on the roadmap;
            locked-mode runs today. And <strong>federation</strong> between
            societies is <MaturityBadge tier="spec" /> — specified, not yet built.
            See{" "}
