...
const EXAMPLE_EXCHANGES: ExampleExchange[] = [
  ...
  },
  {
    ...
    response: 'ATP stands for Allocation Transfer Packets. Think of it like an energy budget in Web4 - you earn it by contributing value to the network, and spend it on operations. Like a biological cell needs ATP for energy, digital agents need an energy budget to act.',
