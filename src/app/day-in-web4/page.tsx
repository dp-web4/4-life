            ...
            <div className="p-4">
              ...
              <div className="bg-gray-900/50 border border-gray-700 rounded-lg p-3 text-xs">
                ...
                <div className="space-y-1.5 text-gray-500">
                  ...
                  <div className="flex justify-between"><span><Link href="/markov-relevancy-horizon" className="text-sky-400 hover:underline">Trust Neighborhood</Link>-adjusted trust</span><span className="text-sky-400">0.64 (0.91 × 0.70 decay over 2 hops)</span></div>
