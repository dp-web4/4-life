      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="mt-8 p-4 bg-gray-800/30 border border-gray-700 rounded-lg">
          <p className="text-xs text-gray-500">
            ...
            See the <a href="https://github.com/dp-web4/SAGE/tree/main/sage/raising" target="_blank" rel="noreferrer" className="text-sky-400 hover:underline">SAGE raising repository</a> for raw data.
          </p>
        </div>
