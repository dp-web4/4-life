          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-900/60 border border-gray-700/60 rounded-xl p-5">
              ...
              <ul className="text-sm text-gray-300 space-y-2">
                ...
                <li><span className="text-purple-300 font-semibold">🤝 Trust Score</span> — her <em>raw</em> reputation, on a <span className="text-gray-200">0.00&ndash;1.00</span> scale. Starts neutral at <span className="text-gray-200">0.50</span>. At or above 0.50: full access. Below 0.50: features get restricted until she rebuilds it &mdash; and if she <em>stays</em> below, that same line becomes fatal.</li>
              </ul>
            </div>
