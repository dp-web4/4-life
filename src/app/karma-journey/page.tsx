    ...
    <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '2rem 1.5rem' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* May 13 LOW — bridge "next life" simulation framing back to the deployment mechanic at the point of use, since the top-of-page intro callout was being read as preamble and missed. */}
