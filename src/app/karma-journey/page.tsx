      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* Jul-8 visitor HIGH: "Drop below 0.5 and this life ends" contradicted First Contact
              ...
              First Contact read as an access threshold and Aliveness as a death threshold. The raw-vs-
              effective clause is carried by this cell's own "Raw trust" heading, so it isn't repeated. */}
          <div style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)', lineHeight: 1.5 }}>Decides <strong style={{ color: 'var(--color-text-secondary)' }}>survival</strong> &mdash; and it is <strong style={{ color: 'var(--color-text-secondary)' }}>raw</strong> trust that is compared, not effective. One line, two consequences: <em>crossing</em> below 0.5 restricts your features right away and is recoverable; only <em>staying</em> below it is fatal &mdash; a sustained collapse, not a single stumble.</div>
        </div>
        <div style={{
          padding: '0.75rem 1rem', borderRadius: '0.5rem',
