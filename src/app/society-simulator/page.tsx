      ...
      <div className="max-w-7xl mx-auto p-4 md:p-8">
        ...
        <details className="mb-4 bg-gray-800/30 rounded-lg border border-gray-700/50 group">
          ...
          <div className="px-4 pb-4 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-gray-300">
            ...
            <div>
              <span className="font-mono font-bold text-sky-400">V3</span> — <span className="text-gray-400">Value Tensor.</span> How others rate the quality of each thing you produce (Valuation, Veracity, Validity). Not scored per-contribution in this demo. <a href="/value-tensor" className="text-sky-400 hover:underline">Learn more →</a>
            </div>
          </div>
        </details>
