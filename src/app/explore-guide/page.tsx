...
function generatePath(answers: Record<string, string>): ExplorationPath {
    ...
    if (style === 'narrative') {
      return {
        ...
        steps: [
          ...
          { title: 'First Contact', description: 'Follow Alice through 16 actions in a Web4 community — watch trust build, spam fail, and karma carry forward', href: '/first-contact', timeEstimate: '7 min', type: 'interactive' },
    ...
    if (style === 'interactive') {
      return {
        ...
        steps: [
          ...
          { title: 'First Contact', description: 'Interactive tutorial that teaches through exploration, not lectures', href: '/first-contact', timeEstimate: '7 min', type: 'interactive' },
        ...
        nextPath: 'Explore the Trust Tensor and Context Boundaries explorers for deeper mechanics.',
      };
    }
  ...
  return {
    ...
    color: '#6ee7b7',
    steps: [
      { title: 'First Contact', description: 'Interactive introduction — the best starting point for anyone', href: '/first-contact', timeEstimate: '7 min', type: 'interactive' },
